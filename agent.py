...
class Agent:
    ...
    # Filipino names for subordinate agents
    _FILIPINO_NAMES = [
    ...
    def _get_agent_name(number: int) -> str:
        """Generate agent name: 'Pareng Boyong' for A0, Filipino names for subordinates"""
        if number == 0:
            return "Pareng Boyong"
        # For subordinates (A1, A2, A3, etc.), use Filipino names cyclically
